...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ht_calibration.setText("0.1037")
        self.energy_gev.setText("270")
        self.bunch_intensity.setText("3e10")
...
if __name__ == '__main__':
    ...
    default_ht_path    = f"/nfs/cs-ccr-bqhtnfs/sps_data/SPS.BQHT"
    default_twiss_path = f"{current_path}/sps_madx/twiss_SPS_q26.parquet"
